...
public class CodeRefTest {
	...
	private static final Pair<String, String> FEATURE_CODE_REFERENCES = Pair.of("file:///",
			"/agent-java-cucumber5/src/test/resources/features/belly.feature:0"
	);

	private static final Pair<String, String> SCENARIO_CODE_REFERENCES = Pair.of("file:///",
			"/agent-java-cucumber5/src/test/resources/features/belly.feature:4"
	);
	...
	private static final List<Pair<String, String>> TWO_FEATURES_CODE_REFERENCES = Arrays.asList(
			Pair.of("file:///", "/agent-java-cucumber5/src/test/resources/features/TwoScenarioInOne.feature:3"),
			Pair.of("file:///", "/agent-java-cucumber5/src/test/resources/features/TwoScenarioInOne.feature:7")
	);
